...
The Maven group-id is defaulted to **org.eclipse.fennec.git** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `org.eclipse.fennec.git`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `org.eclipse.fennec.git` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/org.eclipse.fennec.git/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/org.eclipse.fennec.git.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/org.eclipse.fennec.git/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `org.eclipse.fennec.git`
- [Jenkins org.eclipse.fennec.git branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/org.eclipse.fennec.git/)
