...
The Maven group-id is defaulted to **org.gecko.jgit** in *cnf/build.bnd* using the bnd **-groupid** instruction.
...
## Sonarcloud
  ...
  - Analyze new project
  - check `org.gecko.jgit` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/org.gecko.jgit/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/org.gecko.jgit.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/org.gecko.jgit/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `org.gecko.jgit`
- [Jenkins org.gecko.jgit branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/org.gecko.jgit/)
